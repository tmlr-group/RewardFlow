...
propagate=decay
difference=True
experiment_name=rewardflow_qwen2.5_vl_7b_${propagate}_${difference}_seed_${seed}_solely_step_advantage
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/data1/data/models/Qwen2.5-VL-7B-Instruct \
