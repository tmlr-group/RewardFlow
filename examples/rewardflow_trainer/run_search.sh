...
experiment_name=rewardflow_qwen2.5_3b_seed${seed}_gamma0.95
...
enable_similarity=True # enable similarity-based RewardFlow
similarity_thresh=0.9 # similarity threshold for RewardFlow
