...
seed=0
propagate=decay
experiment_name=rewardflow_qwen2.5_7b_${propagate}_seed_${seed}_v2_gamma0.9
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/data1/data/models/Qwen2.5-7B-Instruct \
    ...
    trainer.total_epochs=103 \
    trainer.val_before_train=True $@
ret=$?
if [ $ret -eq 0 ]; then
    break
else
    echo "Exited with error code $ret, restarting..."
    sleep 3
fi
done
